...
if __name__ == '__main__':
    for param_model_name in [GEMMA_2B, GEMMA_7B, LLAMA_3_8B, GPT_4o_MINI_240718, GPT_4o_240806]:
        for param_dataset_name in [CERD, CAM_MCQ]:
            for param_prompt_id in ['01', '02', '11', '12']:
                for param_target_level in CEFR_LEVELS:
                    ...
                    print("Doing:", param_model_name, param_prompt_id, param_dataset_name, param_target_level)
